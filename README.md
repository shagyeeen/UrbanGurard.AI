# UrbanGuard AI – Urban Infrastructure Health Intelligence Platform
...
## Strategic Mission
> "To engineer the next generation of smart city infrastructure by transforming raw visual data from CCTV networks into actionable structural intelligence."

UrbanGuard AI protects and optimizes the cities of tomorrow, providing specialized **CCTV-based infrastructure auditing** for the **Chennai** and **Coimbatore** sectors. We have moved beyond legacy numerical sensors to **Neural Vision Analysis**, providing an immersive, high-authority tactical interface for modern city operations.
...
## Team Smart Nova
A specialized technical collective from **Sri Krishna College of Technology, Coimbatore**.

- **Sineshana S J** — *Project Lead & UI/UX*
  - The visionary behind the tactical HUD design, glassmorphism aesthetics, and user journey optimization.
- **Tharikasini M S** — *Data Analyst*
  - Architect for structural data mapping, hazard logic, and multi-region risk clustering.
- **Shagin Dharshanth** — *Developer*
  - Engineering the core infrastructure, Groq Vision API integration, state synchronization, and real-time video simulation.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/shagyeeen/urbanguard-ai.git
   ```
...
<div align="center">
  <p><i>Visualizing the Future of Urban Resilience.</i></p>
  <p>© 2026 Smart Nova Collective</p>
</div>
